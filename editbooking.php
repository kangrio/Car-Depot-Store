            ...
            <form action="assets/php/editbookingrequest.php?b_id=<?php echo $b_id?>" method="post" id="form_booking">
              ...
              <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                ...
                <div class="row register-form">
                  ...
                  <div class="col-md-6 center-text">
                    ...
                    <label for="model">รุ่น</label>
                      <select id="model" name="model" class="form-control" required>
                        <option value="<?php echo $row['model'];?>"  selected><?php echo $row['model'];?></option>
                      </select>
                    </div>
                  </div>
                  <div class="col-md-6 center-text">
                    ...
                    <label for="carsign">ป้ายทะเบียน</label>
                      <input type="text" name="carsign" value="<?php echo $row['carsign'] ?>" class="form-control" placeholder="ป้ายทะเบียนรถ *" />
                    </div>
                  </div>
                  <div class="col-md-6 center-text">
                    <div class="form-group">
                    <label for="province">จังหวัดป้าย</label>
                  ...
                  <div class="col-8">
                    <div class="form-group">
                      <input name="submit" type="submit" class="btnRegister" value="ยืนยันการแก้ไข" />
                    </div>
                  </div>
                </div>
              </div>
